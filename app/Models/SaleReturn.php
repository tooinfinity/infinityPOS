...
use App\Builders\SaleReturnBuilder;
 ...
 *
 * @method static SaleReturnBuilder query()
 */
final class SaleReturn extends Model
{
    ...
    public function newEloquentBuilder(mixed $query): SaleReturnBuilder
    {
        return new SaleReturnBuilder($query);
    }

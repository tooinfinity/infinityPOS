...
describe(SaleItemData::class, function (): void {
    describe('creation', function (): void {
        it('creates with required fields', function (): void {
            ...
            expect($data)->toBeInstanceOf(SaleItemData::class)
    ...
    describe('validation', function (): void {
        it('passes validation with valid data', function (): void {
            ...
            $validated = SaleItemData::validate([
        ...
        it('fails validation when product_id is missing', function (): void {
            expect(fn (): array|\Illuminate\Contracts\Support\Arrayable => SaleItemData::validate([
                'quantity' => 5,
                'unit_price' => 1000,
                'unit_cost' => 500,
